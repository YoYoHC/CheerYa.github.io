...
function renderInsight(r){
  ...
  const weak = dims.filter(d => d.score < 70).sort((a,b)=>a.score-b.score);
  const allGood = dims.every(d => d.score >= 70);

  if (allGood) {
    wrap.innerHTML = `
      <div class="insight">
        <h3>健康优等生 · 卓越表现</h3>
        <p>测验显示，您在各个维度都展现出了极高的健康素养与自律能力。您目前的细胞活力、代谢水平和日常精力都处于令人羡慕的巅峰状态。</p>
        <ul>
          <li>拥有充沛的日常精力与良好的情绪稳定性</li>
          <li>基础代谢与皮肤状态维持在优良水平</li>
          <li>具备极强的自我健康管理意识与行动力</li>
        </ul>
        <div class="risk">自然老化趋势提示：真正的顶级抗衰，是在巅峰时期「锁住」青春。虽然您的生活方式无可挑剔，但随着年龄增长，人体内源性的细胞能量（线粒体功能）与天然抗氧化剂仍会面临不可逆的自然流失。</div>
        <p style="margin-top:10px"><b>进阶保养与维持建议：</b>针对您目前的高质量状态，您不需要繁琐的瓶瓶罐罐来进行修补，您需要的是一份维持巅峰状态的青春保险。</p>
        <p>我们建议您在日常优秀的习惯之外，引入含有 <b>麦角硫因、PQQ、AKG、葡萄籽提取物和姜黄素等营养素</b> 的高阶复方，每天极简一粒，为您原本就优秀的细胞代谢额外提供一层深层保护盾。</p>
      </div>
    `;
